...
updatedAt: '2026-05-23T14:32:00.260Z'
role: plan
alwaysLoad: false
...
- \[x] 20. Embedding reconciliation on staleness: both sync.ts and ensureBranchSynced now remove stale embeddings when branch tip changes. Lists current note IDs from attached vault and removes embeddings for IDs that no longer exist.
- \[ ] 22. Unit tests for staleness detection
